...
*À titre d'inspiration, vous trouverez ci-dessous comment compiler et
exécuter directement le premier programme du projet depuis cette feuille.
...
```{code-cell}
! info-111 g++ pbm-affiche.cpp -o pbm-affiche
```
